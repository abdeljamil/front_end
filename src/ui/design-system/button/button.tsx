...
export const Button = ({
    ...
    switch (variant) {
        case "accent"://default
            ...
            break;
        case "secondary":
            variantStyles = "bg-primary-200 hover:bg-primary-400 text-primary rounded";
            break;
        case "outline":
            variantStyles = "bg-white hover:bg-gray-400/50 border border-gray-500 text-gray-900"
            break;
        case "disabled":
            variantStyles = "bg-gray-400 border border-gray-500 text-gray-600 cursor-not-allowed";
            break;
        case "ico":
            if (iconTheme === "accent") {
    ...
    switch (size) {
        ...
        case "medium"://default
            ...
            break;
        case "large":
            sizeStyles = `text_caption1 font-medium ${variant === "ico" ? "flex items-center justify-center w-[60px] h-[60px]" : "px-[22px] py-[18px]"
                }`;
            icoSize = 24;
            break;
    ...
    return (
        <>
            ...
            >
                ...
                <div className={clsx(isLoading && "invisible inset-0 flex items-center justify-center")}>
                    {icon && variant === "ico" ? (
